...
* Versicherungsdaten 1..1 BackboneElement "Angaben zum Versicherungsverhältnis"
  ...
  * BesonderePersonengruppe 0..1 string "Gibt die Zugehoerigkeit des Versicherten zu einer besonderen Personengruppe an. Die Kennzeichnung erfolgt gemaess der Schluesseltabelle."
  * Zuzahlungsstatus 1..1 BackboneElement "Gibt den Zuzahlungsstatus des Versicherten an"
    * KostentraegerAngabestatus 1..1 boolean "Gibt an, ob der Kostenträger die Informationen zum Versicherten angibt" "1 (true) = Informationen werden durch den Kostenträger bereitgestellt, 0 (false) = Informationen werden durch den Kostenträger nicht bereitgestellt"
  ...
  * Versicherungsschutz 1..1 BackboneElement "Angaben zum Versicherungsschutz"
    ...
    * Ende 0..1 date "Gibt das Datum des Endes der Mitgliedschaft des Versicherten bei dem unter Klasse Kostentraeger angegebenen Kostentraeger an oder das Datum des Fristablaufs bei befristeter Gueltigkeit der Karte."
  * DMP 0..* BackboneElement "Angaben zur Teilnahme des Versicherten an DMP-Programmen"
    * KostentraegerAngabestatus 1..1 boolean "Gibt an, ob der Kostenträger die Informationen zum Versicherten angibt" "1 (true) = Informationen werden durch den Kostenträger bereitgestellt, 0 (false) = Informationen werden durch den Kostenträger nicht bereitgestellt"
  ...
  * digitalesDMP 0..* string "Beinhaltet die Information, ob ein digitales DMP vorhanden ist"
  * Kostenerstattung 0..1 BackboneElement "Angaben zur Kostenerstattung für verschiedene Sektoren"
    * KostentraegerAngabestatus 1..1 boolean "Gibt an, ob der Kostenträger die Informationen zum Versicherten angibt" "1 (true) = Informationen werden durch den Kostenträger bereitgestellt, 0 (false) = Informationen werden durch den Kostenträger nicht bereitgestellt"
  ...
  * RuhenderLeistungsanspruch 0..1 BackboneElement "Gibt an, ob für den Versicherten ein ruhender Leistungsanspruch vorliegt"
    * KostentraegerAngabestatus 1..1 boolean "Gibt an, ob der Kostenträger die Informationen zum Versicherten angibt" "1 (true) = Informationen werden durch den Kostenträger bereitgestellt, 0 (false) = Informationen werden durch den Kostenträger nicht bereitgestellt"
