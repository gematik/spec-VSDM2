...
* Versicherter 0..1 BackboneElement "Angaben zum Versicherten" "Angaben zum Versicherten"
  ...
  * StrassenAdresse 0..1 BackboneElement "StrassenAdresse" "Angaben zur Strassenadresse des Versicherten"
    * Strasse 0..1 string "Gibt den Namen der Strasse an." "Pflichtangabe soweit bekannt, wenn die Hausnummer nicht separat abgelegt werden kann, ist es zulässig, die Hausnummer in das Feld Straße zu übernehmen. Anlage 9.4 (Datensätze und Datenbausteine sowie Fehlerkatalog) zur DEÜV, siehe www.gkv-datenaustausch.de/arbeitgeber/deuev/gemeinsame_rundschreiben/gemeinsame_rundschreiben.jsp"
