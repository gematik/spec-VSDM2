Profile: VSDMPatientBase
Parent: TIPatient
Title: "Versicherter"
Description: "Basis-Angaben zum Versicherten im Versichertenstammdatenmanagement (VSDM) 2.0"
...
* insert Meta
* .
  * ^short = "Basis-Versicherter im VSDM"
  * ^definition = """
      ...
      Es ist nicht zur direkten Nutzung in VSDM 2.0-Ressourcen vorgesehen.
    """
