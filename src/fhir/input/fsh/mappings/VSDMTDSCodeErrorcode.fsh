...
* sourceUri = Canonical(VSDMTDSCodeVS|1.0.2-dev)
* targetUri = Canonical(VSDMErrorcodeVS|1.0.2-dev)
* group[+]
  * source = Canonical(VSDMTDSCodeCS|1.0.2-dev)
  * target = Canonical(VSDMErrorcodeCS|1.0.2-dev)
