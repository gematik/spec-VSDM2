...
* sourceUri = Canonical(VSDMTDSCodeVS|1.1.0)
* targetUri = Canonical(VSDMErrorcodeVS|1.1.0)
* group[+]
  * source = Canonical(VSDMTDSCodeCS|1.1.0)
  * target = Canonical(VSDMErrorcodeCS|1.1.0)
