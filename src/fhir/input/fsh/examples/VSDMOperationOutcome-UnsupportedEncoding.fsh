...
Title: "Fehlermeldung SERVICE_UNSUPPORTED_ENCODING"
...
* issue[+]
  ...
  * details[+]
    * coding[0] = VSDMErrorcodeCS#SERVICE_UNSUPPORTED_ENCODING "Das vom Clientsystem angefragte Kodierungsverfahren [encoding scheme] wird nicht unterstützt."
