...
* meta
  * profile[0] = Canonical(VSDMBundle|1.1.3)
...
* meta.profile[0] = Canonical(VSDMPatient|1.1.3)
...
* address[StrassenAdresse]
  ...
  * postalCode = "10000"
  * country = "Kosovo"
    * extension[countryCodeExt].valueCoding = VSDMISO3166ErgaenzungCS|1.1.3#XK
...
* meta.profile[0] = Canonical(VSDMCoverageGKV|1.1.3)
