...
* meta
  * profile[0] = Canonical(VSDMBundle|1.1.1-dev)
...
* meta.profile[0] = Canonical(VSDMPatient|1.1.1-dev)
...
* address[StrassenAdresse]
  ...
  * postalCode = "10000"
  * country = "Kosovo"
    * extension[countryCodeExt].valueCoding = VSDMISO3166ErgaenzungCS|1.1.1-dev#XK
...
* meta.profile[0] = Canonical(VSDMCoverageGKV|1.1.1-dev)
