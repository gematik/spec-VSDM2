...
* extension[vsdm-kostentragerAngabestatus].valueCodeableConcept.coding[+] = VSDMKostentraegerAngabestatusCS#dmp
* extension[vsdm-kostentragerAngabestatus].valueCodeableConcept.coding[+] = VSDMKostentraegerAngabestatusCS#wahltarife
